...
public class PasswordValidation {
	...
	/**
	 * Password pattern to check for the following conditions:
	 * Contains Alphanumeric and one special character
	 * Length:Min 6 Max 8
	 * Always start with Capital letter followed by lower-case alphanumeric characters
	 * Ends with one special character from the list:{!@$%#}
	 */
	 ...
	 * Contains atleast 1 uppercase and 1 lowercase characters
	 */
