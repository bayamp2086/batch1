...
import com.bayamp.akshatha.training.dataproviderutil.Data;
...
public class DataProviderProgramTests {
	...
	@Test(priority = 1, groups = { "api", "p1",
			"addition" }, dataProvider = "getMyDataFromCSV", dataProviderClass = com.bayamp.akshatha.training.dataproviderutil.DataProviderUtility.class)
	@Data(file = "src/main/resources/addition.csv")
