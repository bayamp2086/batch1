...
public class PassWordTest {	
	...
	public static void exceptionThrownWithNegativeValues() throws Exception  {
		...
		boolean expected = PassWordUtility.isCorrectPassword(inputData);
    ...
    public static void positiveValues() {
   	 ...
   	 boolean actual = PassWordUtility.isCorrectPassword(input);
    ...
    public static void splCharc(String data) {
   	 boolean expected = true;
   	 boolean actual = PassWordUtility.isCorrectPassword(data);
   	 Assert.assertEquals(actual, expected);
    }
