...
public class RestAssuredApiTest {
	...
	String putEndPoint = "/bayamp/update/E1cBCCQFL";
	String deleteEndPoint = "/bayamp/delete/V13RUPX58";
	...
	public void Get() {
		...
		try {
			map = mapper.readValue(responseBody, new TypeReference<Map<String, String>>(){});
